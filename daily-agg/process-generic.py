...
def process(date, game): 
    transfer_file_path = "rawdata/"+game+"/"+date+"/in-game-token-transfers.csv"
    block_file_path = "rawdata/"+game+"/"+date+"/blocks.csv"
    transaction_file_path = "rawdata/"+game+"/"+date+"/in-game-transaction.csv"
